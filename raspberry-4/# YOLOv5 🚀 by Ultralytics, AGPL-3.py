...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / Veri.yol, help='file/dir/URL/glob/screen/0(webcam)')
...
# counter so each image name is different
...
def main(opt):
    ...
    while True:
        ...
        veri_yol_dosya = os.getcwd() + veri_yol + "/" + "image{}.jpg".format(counter)
